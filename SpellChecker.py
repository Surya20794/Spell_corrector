...
# - Building the Model
# - Training the Model
# - Fixing Custom for cheking my model Sentences
...
#for i in (books):
    #l.append(i)
    #print(i)
    #print("There are {} words in {}.".format(books[i].split(), book_files[i])
...
def decoding_layer(dec_embed_input, embeddings, enc_output, enc_state, vocab_size, inputs_length, targets_length, 
    ...
    #nitial_state = tf.contrib.seq2seq.AttentionWrapperState(enc_state,
...
# Examples of corrected sentences: if i am checking with some given book then it is predicting like.

# -(input)==== Spellin is difficult, whch is wyh you need to study everyday.
# -(output)==== Spelling is difficult, which is why you need to study everyday.
# 
# 
